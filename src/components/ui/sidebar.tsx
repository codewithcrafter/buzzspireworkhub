  ...
  return (
    ...
    >
      ...
      <div className="h-16 flex items-center justify-between px-4 border-b border-border/60">
        {!isCollapsed && (
          <Link href="/" className="flex items-center gap-2 font-heading font-bold text-xl tracking-tighter text-primary">
            <Sparkles className="size-5 fill-primary/10 animate-pulse text-primary" />
            <span>{logoText}</span>
