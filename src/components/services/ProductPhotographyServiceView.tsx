...
export default function ProductPhotographyServiceView() {
  return (
    <div className="w-full bg-slate-50 font-sans select-none bg-[linear-gradient(to_right,#8080800a_1px,transparent_1px),linear-gradient(to_bottom,#8080800a_1px,transparent_1px)] bg-[size:24px_24px] relative overflow-hidden">
      ...
      <LeadFormSection
        eyebrow="LET'S TALK"
        heading="Ready to capture high-converting product photos?"
        description="Tell us about your product catalog size and platform image specs (Amazon, Flipkart, Shopify). Our shoot coordinators will get back with options."
        defaultService="Product Photography"
        source="Product Photography Page"
      />
    </div>
  );
}
