        ...
        <div className="max-w-4xl mx-auto space-y-6">
          ...
          <div className="space-y-6 text-base md:text-lg text-slate-600 leading-relaxed">
            {service.fullContent.map((paragraph, idx) => (
              <p key={idx} className="bg-white p-6 md:p-8 rounded-3xl border border-slate-200/60 shadow-xl shadow-indigo-900/5 hover:shadow-2xl hover:shadow-indigo-900/10 transition-all duration-300">
                {paragraph}
              </p>
            ))}
          </div>
      ...
      <ScrollReveal>
        <div className="space-y-10">
          <div className="text-center max-w-2xl mx-auto space-y-3">
            ...
            <h3 className="text-2xl md:text-3xl font-heading font-extrabold text-slate-900">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {service.features.map((feature, idx) => (
              <ScrollReveal key={idx} delay={idx * 0.1}>
                <div className="p-8 rounded-3xl bg-white border border-slate-200/60 shadow-xl shadow-indigo-900/5 hover:shadow-2xl hover:shadow-indigo-900/10 transition-all duration-300 hover:border-primary/40 transition-all duration-300 h-full flex flex-col justify-between group">
                  <div className="space-y-4">
                    ...
                    <h4 className="font-heading font-bold text-xl text-slate-900 group-hover:text-primary transition-colors">
                      {feature.title}
                    </h4>
