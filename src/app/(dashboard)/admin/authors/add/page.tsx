...
function AddAuthorForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const data = await res.json();
      if (res.ok) {
        toast({ title: "Author created", description: "Author successfully added.", type: "success" });
      ...
      toast({ title: "Error", description: "Failed to create author.", type: "error" });
      setIsSubmitting(false);
    }
  };
  ...
  return (
    <div className="space-y-6 pb-16 max-w-3xl">
      ...
      <PageHeader
        title="Add Author"
        description="Create a new author profile to assign to your blog posts."
      />
      ...
      <form onSubmit={handleSubmit} className="space-y-6 bg-card border border-border/60 p-6 rounded-2xl shadow-sm">
        ...
        <div className="space-y-1">
          ...
          <textarea
            ...
            placeholder="Write a short professional author biography..."
