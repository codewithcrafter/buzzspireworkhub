...
export default function ServicesClientView({ content = {} }: { content?: any }) {
  ...
  return (
    <main className="w-full bg-slate-50 font-sans select-none text-slate-900 font-sans">
      ...
      <section className="pt-24 pb-16 md:pt-32 md:pb-24 px-6 md:px-10 lg:px-12 w-full max-w-[1720px] mx-auto border-b border-slate-200/50 min-h-[650px] flex items-center">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center w-full">
          ...
          <div className="space-y-8">
              ...
              <div className="space-y-4 text-base md:text-lg text-slate-600 leading-relaxed mt-8">
      ...
      {/* 7. CONSULTATION LEAD FORM */}
      <LeadFormSection
        eyebrow="LET'S TALK"
        heading="Ready to Scale Your Marketing?"
        description="Tell us about your business goals and what services you're looking for. We'll connect with a customized growth audit and strategy."
        defaultService="Other / Full Growth Suite"
        source="All Services Overview Page"
      />
    </main>
  );
}
