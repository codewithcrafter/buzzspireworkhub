          ...
          >
            ...
            <div className="flex-1 min-h-0 overflow-y-auto p-4 space-y-4 bg-muted/20">
              ...
              {!chatSessionId && currentStep === "SERVICE" && (
                <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="flex flex-col gap-2 mt-2 max-h-[250px] overflow-y-auto pr-1">
...
fs.writeFileSync(path.join(__dirname, 'src', 'components', 'chat', 'LeadChatbot.tsx'), fileContent);
console.log('LeadChatbot.tsx replaced');
